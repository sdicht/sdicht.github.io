...
Submit your portfolio [here](https://www.dropbox.com/request/2szzchrjfp7z3ql3wrlb) 📥 (no registration required)
...
3. Glossary — a few words you looked up, with their meaning and a short note on why they stood out.
...
- Consistency across the semester (built gradually, not written the week before submission)
- Presence of the five required elements in each entry

Language errors, awkward phrasing, or simple vocabulary will not be penalized.

### Capstone Essay

At the end of the portfolio, choose ONE text from the syllabus  to revisit for a longer analysis using Wolosky and/or Eagleton — ideally one where your original diary entry left a question unresolved, or where something in the text has stayed with you.
